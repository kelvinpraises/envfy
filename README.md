...
This project is for [SUSTAINABLE BLOCKCHAIN HACKATHON](https://gitcoin.co/issue/29009) it uses [IPFS](https:) an efficient decentralized protocol for storing and accessing data consistently and [Ceramic](https://ceramic.network/) a decentralized protocol for building decentralized data streams and more on IPFS.
